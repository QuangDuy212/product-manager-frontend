...
import { callFetchCategory, callFetchProduct, callFetchTag } from '@/config/api';
...
export const fetchTag = createAsyncThunk(
    ...
    async ({ query }: { query: string }) => {
        const response = await callFetchTag(query);
        return response;
    }
)
...
export const tagSlide = createSlice({
    ...
    extraReducers: (builder) => {
        ...
        builder.addCase(fetchTag.pending, (state, action) => {
